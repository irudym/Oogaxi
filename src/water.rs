...
fn simulate_water(mut surface: Query<&mut WaterSurface>) {
...
fn update_water_mesh(mut meshes: ResMut<Assets<Mesh>>, surfaces: Query<(&WaterSurface, &Mesh2d)>) {
